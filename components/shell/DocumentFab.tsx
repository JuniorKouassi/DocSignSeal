...
/* Scoped to the Documents route only (see app/dashboard/documents/layout.tsx)
   ...
   appearing only on its Documents screen. "From files" is real -- it's the
   existing template-upload flow (app/dashboard/templates/new); "From
   Gallery" and "Scan" have no backing implementation yet (no camera/photo
   picker plumbing exists) so they're visibly present but disabled, same
   scoping decision as the Signatures speed-dial. */
